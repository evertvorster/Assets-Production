...
{    
   ...
   vec3 fvDrift          = fvCloudLayerDrift.zzw*(cnoise.xyw * 0.25 + cnoise.aaa * 0.75 - vec3(0.0,0.0,0.5)) + vec3(0.0,0.0,1.0);
   ...
   fvCloud4.a            = saturatef((fvCloud4.a*fvDrift.z       )*4.0); // 0.0000 - 0.2500
   ...
   vec2 fvCloudShadow    = vec2(fCloudShadow2,fCloudShadow4) * fvDrift.zz;
   ...
   vec3 fvCloud1c,fvCloud2c,fvCloud4c;
